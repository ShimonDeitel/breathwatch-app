...
struct ContentView: View {
    ...
    private func row(_ entry: SymptomEntry) -> some View {
    ...
    private var addSheet: some View {
        NavigationStack {
            Form {
                ...
                TextField("Severity (1-5)", value: $draft.severity, format: .number)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        if let editing {
                            var updated = draft
                            updated = SymptomEntry(id: editing.id, createdAt: editing.createdAt, petName: draft.petName, symptom: draft.symptom, severity: draft.severity, date: draft.date)
